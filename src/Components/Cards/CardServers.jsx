...
export default function CardServers() {
	...
	const convertTimestamp = (timestamp) => {
		...
		const date = new Intl.DateTimeFormat('pt-br', { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', second: '2-digit' }).format(convert_timestamp);
		return date;
	};
              ...
              <div className="card">
                  <div className="card-header border-0">
                      <div className="row align-items-center">
                          <div className="col">
                              <h3 className="mb-0">Hospedagens</h3>
                          </div>
                          <div className="col text-right">
                              <a href="/servers" className="btn btn-sm btn-primary">Todos</a>
                          </div>
                      </div>
                  </div>
